...
class Promethee:
        ...
        for x in range (len(self.matrix)):
            for i in range (len(self.matrix[x])):
                if (self.criteriaMax[i] - self.criteriaMin[i] == 0):
                    ...
                    if (str(self.criteriasType[i]).lower() == "cost"):
    ...
    def enteringFlow(self):
        ...
        for x in range(len(self.alternatives)):
            ...
            #print(sum(alternativesValues)/len(self.criterias))
            self.enteringFlowArray.append(sum(alternativesValues)/len(self.criterias))
    ...
    def leavingFlow(self):
        ...
        for x in range(len(self.alternatives)):
            ...
            #print(sum(alternativeValues)/len(self.criterias))
            self.leavingFlowArray.append(sum(alternativeValues)/len(self.criterias))
